...
Route::Route(const ndn::PrefixAnnouncement& ann, uint64_t faceId)
  ...
  , flags(ndn::nfd::ROUTE_FLAG_CAPTURE) // default to CAPTURE to avoid using parent routes when computing FIB, see: https://redmine.named-data.net/projects/nfd/wiki/RibMgmt
